...
def request_to_newsauthors_mail_async(user_id):
    ...
    # Для смены адресатов с admins на managers изменить функцию на mail_managers
    ...
    print(f'SysInfo: Отправлено письмо админам/модераторам о добавлении в группу авторов новостей')
